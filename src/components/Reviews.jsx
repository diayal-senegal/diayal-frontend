           ...
           <div className='flex gap-10 md-lg:flex-col'>
              <div className='flex flex-col gap-2 justify-start items-start py-4'>
                <div className=''>
                 ...
                 <p className='text-sm text-slate-600'>({totalReview}) avis</p>
              </div>
                  ...
                  <div className='flex justify-start items-center gap-5'>
                    ...
                    <div className='flex justify-start items-center gap-5'>
                     <div className='text-md flex gap-1 w-[93px]'>
                       ...
                       <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                          <div style={{width: `${Math.floor((100 * (rating_review[2]?.sum || 0)) / totalReview)}%`}} className='h-full bg-[#Edbb0E] w-[80%]'>
                          </div>
                       </div> 
                    ...
                    <div className='flex justify-start items-center gap-5'>
                     <div className='text-md flex gap-1 w-[93px]'>
                       ...
                       <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                          <div style={{width: `${Math.floor((100 * (rating_review[3]?.sum || 0)) / totalReview)}%`}} className='h-full bg-[#Edbb0E] w-[89%]'>
                          </div>
                       </div> 
                    ...
                    <div className='flex justify-start items-center gap-5'>
                     <div className='text-md flex gap-1 w-[93px]'>
                       ...
                       <div className='w-[200px] h-[14px] bg-slate-200 relative'>
                          <div style={{width: `${Math.floor((100 * (rating_review[4]?.sum || 0)) / totalReview)}%`}} className='h-full bg-[#Edbb0E] w-[96%]'>
                          </div>
                       </div> 
                                         ...
                                         <div className='flex gap-1'>
                                          ...
                                          />
                                           ...
                                           <form onSubmit={review_submit}>
                                             ...
                                             <div className='mt-2'> <button className='py-2 px-5 bg-indigo-500 text-white rounded-sm'>Envoyer</button></div>
                                           </form>
                            </div> : <div className='gap-2 flex justify-start items-start'> <span>Pour laisser un avis, vous devez vous connecter</span>
