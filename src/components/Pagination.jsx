   ...
   if (dif <= showItem){
    ...
    const createBtn = () => {
       ...
       for (let i = startPage; i < endPage; i++) {
        btns.push(
            <li onClick={() => setPageNumber(i)}  className={`${pageNumber === i ? 'bg-[#059473] shadow-lg shadow-indigo-300/50 text-white' :
             'bg-slate-600  hover:bg-[#059473] shadow-lg hover:shadow-indigo-500/50 hover:text-white text-[#d0d2d6]'}
